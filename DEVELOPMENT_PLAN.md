...
| 5 | Интеграция pipeline (STT → LLM → TTS) | ⬜ Не начат |
| 6 | IPC-сервер | ⬜ Не начат |
| 7 | Tkinter UI с диагностикой | ⬜ Не начат |
| 8 | Финальное тестирование и полировка | ⬜ Не начат |
...
## Этап 8: Финальное тестирование и полировка
